  ...
  return (
    <div className="space-y-6">
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-6">
        ...
        <KPI label="Avg Time" value={`${data.kpis.averageTimeToSettlementDays}d`} trend="-0.6d week over week" trendTone="positive" />
        ...
        <KPI label="Compliance Exceptions" value={String(data.kpis.complianceExceptions)} trend="Stable this week" trendTone="neutral" />
      </section>
